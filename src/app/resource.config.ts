import {ResourcePackage} from "./core/resource/model/resource.model";
...
export const resourcePackage: ResourcePackage = {
  ...
  "hu": {
    ...
    //Add recipe
    "ADD_RECIPE.BUTTON" : "Mentés",
    "ADD_RECIPE.FIELD.ERROR.MESSAGE" : "Mező megadása kötelező",
    "ADD_RECIPE.FIELD.TITLE.LABEL" : "Név",
    "ADD_RECIPE.FIELD.CATEGORY.LABEL" : "Kategória",
    "ADD_RECIPE.FIELD.TIME.HOUR.LABEL" : "Óra",
