// import {RecipeListState} from "../../mainpage/model/recipeList.state.model";
// import {CoreAction} from "../../../core/state/model/core.action.model";
// import {RECEIVE_RECIPE_LIST, REQUEST_RECIPE_LIST} from "../../mainpage/action/main-page.action-factory";
...
//
// export function recipeListReducer (state: RecipeListState, action: CoreAction<any>): RecipeListState {
//   if (!state) {
//     state = {
